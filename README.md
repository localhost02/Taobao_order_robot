...
![流程图](http://p27z4ahy7.bkt.clouddn.com/2e3aba61a8652cac683c3e12b4694c31.png)

**Trip：**
* 使用小附件方式发送邮件，大于50M文件可能发送失败（邮箱附件最大值，超过即属于超大附件了）。文件已压缩为zip，再进行发送，这样文件更小，而且可规避某些邮箱服务器不允许直接发送exe文件
